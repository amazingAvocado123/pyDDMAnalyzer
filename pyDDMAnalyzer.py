#!/usr/bin/env python3
"""
DDM Analyzer - Complete Edition
Differential Dynamic Microscopy with full notebook feature parity
...
Author: Enhanced from notebook implementation
"""
...
class DDMAnalyzer:
    """
    Complete DDM Analyzer with all notebook capabilities
    """
    ...
    def time_averaged(self, dt, max_couples=None):
        """
        Time-averaged spectrum difference
        Implements notebook's timeAveraged function with maxNCouples control
...
def merge_ddm_datasets(analyzers: List[DDMAnalyzer], frequencies: List[float],
    ...
    merged = DDMAnalyzer(analyzers[0].params)
...
def run_ddm_analysis(image_path: str, pixel_size_um: float, magnification: float,
                    ...
                    points_per_decade=15, max_couples=None):
    """
    ...
    print("="*60)
    print("DDM ANALYSIS - Complete Edition")
    print("="*60)
...
def main():
    parser = argparse.ArgumentParser(
        description='DDM Analysis - Complete Edition with notebook feature parity',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  # Single frequency analysis
  python ddm_complete.py data/video.mp4 --pixel-size 0.108 --mag 100 --fps 400 -o results/

  # Multi-frequency merging
  python ddm_complete.py --merge data/400Hz/ data/4Hz/ --frequencies 400 4 \\
         --pixel-size 0.108 --mag 100 -o results_merged/

  # Fast evaluation mode
  python ddm_complete.py data/test/ --pixel-size 0.108 --mag 100 --fps 400 \\
